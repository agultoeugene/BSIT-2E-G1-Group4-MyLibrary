...
<div class="container manage-container ">
    ...
    <div id="manageHeader" class="manage-header mb-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h2 class="fw-bold">Borrowed List</h2>
        <a href="borrow.php" class="btn btn-primary btn-sm" style="white-space:nowrap;">Add Borrow</a>
    </div>

<div id="manageActions" class="mb-0 d-flex align-items-center gap-2 action-row flex-wrap">

    <!-- Export Main Table -->
    <button id="exportBorrowPdf" class="btn btn-secondary btn-sm" style="white-space:nowrap;">
        <i class="bi bi-file-pdf"></i> Export PDF
    </button>
    <button id="exportBorrowExcel" class="btn btn-success btn-sm" style="white-space:nowrap;">
...
<div id="returnedSection" class="report-section d-none">
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div>
      <h3 class="fw-bold">Returned Books</h3>
      <p class="text-muted mb-0">Records for books returned on time.</p>
    </div>
    <a href="manageBorrow.php" class="btn btn-outline-secondary btn-sm" style="white-space:nowrap;">Back to Borrowed List</a>
  </div>

  <input type="text" id="searchReturnedInput" class="form-control mb-3" placeholder="Search returned records...">
  ...
  <div class="mb-5 d-flex flex-wrap gap-2">
    <button id="exportReturnedPdf" class="btn btn-secondary btn-sm me-2" style="white-space:nowrap;">
      <i class="bi bi-file-pdf"></i> Export PDF
    </button>
    <button id="exportReturnedExcel" class="btn btn-success btn-sm" style="white-space:nowrap;">
      <i class="bi bi-file-earmark-excel"></i> Export Excel
    </button>
  </div>
</div>

<div id="overdueSection" class="report-section d-none">
  <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    <div>
      <h3 class="fw-bold">Overdue Returned Books</h3>
      <p class="text-muted mb-0">Records for books returned after the due date.</p>
    </div>
    <a href="manageBorrow.php" class="btn btn-outline-secondary btn-sm" style="white-space:nowrap;">Back to Borrowed List</a>
  </div>

  <input type="text" id="searchOverdueInput" class="form-control mb-3" placeholder="Search overdue records...">
  ...
  <div class="mb-5 d-flex flex-wrap gap-2">
    <button id="exportOverduePdf" class="btn btn-secondary btn-sm me-2" style="white-space:nowrap;">
      <i class="bi bi-file-pdf"></i> Export PDF
    </button>
    <button id="exportOverdueExcel" class="btn btn-success btn-sm" style="white-space:nowrap;">
      <i class="bi bi-file-earmark-excel"></i> Export Excel
    </button>
  </div>
</div>
