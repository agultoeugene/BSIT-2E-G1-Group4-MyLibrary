...
<head>
    ...
    <link rel="stylesheet" href="../assets/borrow.css" />
</head>
<body>
               ...
               <div class="mb-4 text-start">
                    ...
                    <div class="row g-2"> 
                        <div class="col-md-5">
                          ...
                          <div id="lastName-error" class="text-danger small mt-1" style="display: none;">Please enter your last name.</div>
                        </div>

                        <div class="col-md-5">
                         <input type="text" id="firstName" placeholder="First Name" class="form-control">
                         <div id="firstName-error" class="text-danger small mt-1" style="display: none;">Please enter your first name.</div>
                        </div>

                        <div class="col-md-2">
                          <input type="text" id="mi" placeholder="M.I." class="form-control">
                        </div>
                 </div>
               </div>
            
               <div class="mb-4 text-start">
               <label class="form-label fw-bold mb-1">Student Number</label>
                     <input type="text" id="studentNumber" placeholder="e.g. 2024100100" class="form-control">
                     <div id="studentNumber-error" class="text-danger small mt-1" style="display: none;">Please enter your student number.</div>
               </div>
        ...
        <div class="col-md-6 d-flex justify-content-center">
            <table class="table table-borderless w-auto"> 
                <tbody>
                    ...
                    <tr>
                        <td class="fw-bold text-end">Student Number:</td>
                        <td id="confirm-studentNumber" class="text-primary text-start">--</td>
                    </tr>
                    <tr>
...
<div id="step-3" style="display: none;">
    <div class="text-center py-5">
        ...
        <div class="mt-5 d-flex justify-content-center gap-2">
            ...
            <a href="/BSIT-2E-G1-GROUP4-MYLIBRARY/index.php" class="btn btn-outline-secondary px-5">
                Go to Dashboard
            </a>
        </div>
    </div>
